...
public class CreateContact extends Login {
	...
	public void createContactTwo(String service, String contactPhone, String lastName, String accountName) throws IOException {
		...
		log.info("Fluent wait is successfully implemented");
